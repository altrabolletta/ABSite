...
namespace ABSite.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //    var res = await UserManager.UpdateAsync(loggedinUser);
            //}
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            //var email = info.ExternalIdentity.FindFirstValue("urn:facebook:email");
            ...
            if (loginInfo.Login.LoginProvider == "Facebook")
            {
                ...
                //myInfo = fb.Get("/"+ myInfo.id+ "/friends");
            ...
            {
                case SignInStatus.Success:
                    //var loggedinUser = await UserManager.FindByEmailAsync(loginInfo.Email);
                    var loggedinUser = await UserManager.FindAsync(loginInfo.Login);
                    if (loggedinUser != null)
                    {
                        loggedinUser.LastLogin = DateTime.Now;
                        var res = await UserManager.UpdateAsync(loggedinUser);
